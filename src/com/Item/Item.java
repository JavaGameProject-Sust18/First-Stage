...
public class Item {
    ...
    public static Item woodItem=new Item(Assets.TWood,"Wood",0);
    public static Item rockItem=new Item(Assets.SRock,"Rock",1);
    public static Item dimension=new Item(Assets.dimension,"Rock",2);
